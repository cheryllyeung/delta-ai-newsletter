...
0. is_ai_related：這篇文章跟「基因組學／多體學檢測」有沒有實質關係。
   ...
   次世代定序（NGS）、全基因體定序（WGS）、全外顯子定序（WES）、液態
   活檢（liquid biopsy、ctDNA、cfDNA）、微小殘留病灶（MRD）監測、
   癌症早篩（MCED）、伴隨式診斷（CDx）、NIPT、帶因篩檢、多基因風險
   分數（PRS）、腫瘤基因分析、單細胞與空間生物學、甲基化檢測、藥物
   基因體學，以及多體學各分支：蛋白質體學（proteomics）、代謝體學
   （metabolomics）、轉錄體學。也包含這些領域廠商的財務、併購、法規、
   給付動態（NBDMD 2026-09 補充的關鍵字）。也包含產業營運環境的
