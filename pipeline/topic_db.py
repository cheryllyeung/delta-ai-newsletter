...
def get_connection(db_path: str) -> sqlite3.Connection:
    ...
    # tldr_json：每期摘要頁頂部的 TLDR（趨勢／重點／觀察），genomics 2026-09-01 加。
    for column_def in ("period_start TEXT", "period_end TEXT", "cadence TEXT", "column_json TEXT", "tldr_json TEXT"):
        try:
